...
export const works = [
  ...
  "Develop and maintain user interfaces using React.js, Angular",
...
export const portfolio = [
  ...
  },
  {
    ...
    description:
      "I developed the official site of Avartan Technology, a RnD company focus on Data Driven Optimization.",
  },
  {
    src: wallG,
    ...
    tags: ["HTML5", "CSS3", "Javascript", "Bootstrap"],
    description:
      "I worked as a project manager in the respective project. I have also developed the website and currently worked on the firmware and backend of the Wall-G.",
  },
];
