  ...
  return (
    ...
    >
      <div className="text-left hero_content">
        <h1 className="text-white text-7xl max-w-2xl">
          turning ideas into real life{" "}
          <span className="bg-gradient-to-r from-secondary-color via-blue-500 to-pink-400 inline-block text-transparent bg-clip-text">
            products
          </span>
          !
        </h1>
