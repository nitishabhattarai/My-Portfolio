    ...
    <div className="bg-[#1a1a1a] text-white p-20 portfolio-page" id="portfolio">
      ...
      <div className="mt-8 grid grid-cols-2 gap-10 portfolio">
        {portfolio.map((item, key) => {
          return (
            <div key={key} className="text-white shadow-md cursor-pointer portfolio-card">
              <a href={item.link} target="_blank">
                <div className="relative overflow-hidden bg-gray-400">
                  ...
                  <img
                    ...
                    alt={item.alt}
                  />
                  <div className="p-10 hidden flex-col justify-center text-center bg-primary absolute top-0 z-20 h-full content">
